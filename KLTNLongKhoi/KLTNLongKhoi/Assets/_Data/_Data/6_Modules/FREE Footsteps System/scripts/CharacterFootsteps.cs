...
namespace Footsteps
{
	...
	public class CharacterFootsteps : MonoBehaviour
	{
		...
		void Start()
		{
			...
			else if (!FindFirstObjectByType<SurfaceManager>()) errorMessage = "Please create a Footstep Database, otherwise footsteps cannot be played, you can create a database" +
