...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Header("VFX")]
        [SerializeField] private GameObject runningVFX; // Reference to the smoke VFX GameObject
        ...
        private void Move()
        {
            ...
            // Toggle running VFX based on sprint and movement
            if (runningVFX != null)
            {
                bool isRunning = input.sprint && input.move != Vector2.zero && Grounded;
                runningVFX.SetActive(isRunning);
            }
